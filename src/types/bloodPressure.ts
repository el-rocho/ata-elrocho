...
export interface AppSettings {
  ...
  guidelineProfile: GuidelineProfile; // Referencia utilizada para clasificar las mediciones domiciliarias
  showInformationalLabels: boolean; // Mostrar clasificaciones, objetivos y avisos no críticos
